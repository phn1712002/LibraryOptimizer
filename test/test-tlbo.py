...
def test_sphere_function_minimization():
    """Test TLBO on sphere function (minimization)."""
    def sphere_function(x):
        return np.sum(x**2)
    
    method = create_solver(
        solver_name='TeachingLearningBasedOptimizer',
...
def test_rastrigin_function_minimization():
    """Test TLBO on Rastrigin function (minimization)."""
...
def test_maximization():
    """Test TLBO on maximization problem."""
...
def test_custom_teaching_factor():
    """Test TLBO with custom teaching factor range."""
    def sphere_function(x):
        return np.sum(x**2)
    ...
    method = create_solver(
        ...
        dim=2,
        maximize=False,
        teaching_factor_range=(1, 3)  # Custom TF range
    )
...
def test_high_dimensional_problem():
    """Test TLBO on higher dimensional problem."""
    def sphere_function(x):
        return np.sum(x**2)
...
if __name__ == "__main__":
    ...
    test_maximization()
    test_custom_teaching_factor()
    test_high_dimensional_problem()
    print("All TLBO tests passed!")
